...
router.post('/uploadprofilepic', userAuth,(req, res) => controller.uploadProfilepic(req,res))
...
router.get('/completedlessonview/:id/:userId', (req, res) => controller.CompletedLessonsView(req, res))
router.get('/completedChapterview/:id/:userId',  (req, res) => controller.CompletedChapterView(req, res))
router.get('/enrolledview/:id',  (req, res) => controller.EnrolledCourseForStudent(req, res))
