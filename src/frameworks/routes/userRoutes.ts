...
router.get('/completedlessonview/:id/:userId', CourseAccessAuth, (req, res) => controller.CompletedLessonsView(req, res))
router.get('/completedChapterview/:id/:userId', CourseAccessAuth, (req, res) => controller.CompletedChapterView(req, res))
